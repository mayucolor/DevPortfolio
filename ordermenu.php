...
<body>
  ...
  <!--/ Nav End /-->
  <br><br><br><br><br><br>
  <h2 class="text-center">Confirm Order Details</h2>  
        ...
        echo "</div>"; 
         ...
         echo "<div class='card w-25 mx-auto pl-3 pt-1'>";    
              foreach($result as $row){
                ...
                echo "<a href='action.php?actiontype=dele&id=$id' class='text-success border-bottom w-100'> Delete </a><br>";
            }        
          echo "</div>";
