<?php
    ...
    $result = $user->getSpecificUser($id);
?>
    ...
    <form action="action.php" method="post">
          <div class=" w-25 mx-auto mt-5">
            <h3>E D I T U S E R</h3>
              First Name <br> 
              <input type="text" name="fname" class="form-control" value="<?php echo $result['first_name']; ?>"> <br>
              Last Name <br>
              <input type="text" name="lname" class="form-control" value="<?php echo $result['last_name']; ?>"> <br>
              Email <br> 
              <input type="email" name="email" class="form-control" value="<?php echo $result['email']; ?>"> <br>
              Password <br> 
              <input type="password" name="pass" class="form-control" value="<?php echo $result['password']; ?>"> <br>
